			...
			success : function(response){
				...
				if(result.Code == "ok" || result.Code == "OK"){
					if(result.Confirmation == "ConfirmationRequired"){
						...
						$('#tbtn-cancel').click(function(e){e.preventDefault(); setTimeout(' window.location.href = "lec.html"; ',10);});
		...
		$.ajax({
			...
			success : function(response){
				...
				if(result.Code == "ok" || result.Code == "OK"){
					...
					$('#rbtn-lec').click(function(e){e.preventDefault(); setTimeout(' window.location.href = "lec.html"; ',10);});
				}
				else if(result.Code == "Failed"){
					data.length = 0;
					$("#rresult").fadeIn(100, function(){
